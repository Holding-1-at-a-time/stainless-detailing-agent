import fs from 'fs';
import type { ResponseLike } from 'detailing_agent/internal/to-file';
import { toFile } from 'detailing_agent/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('detailing_agent/core/uploads');
    await expect(
